package io.mouadoumous.permission.dialog;
...
import club.alkhawarizmi.app.R;
...
public class AppSettingsDialog implements Parcelable {
    ...
    public static class Builder {
         ...
         * <p>
         * To know if a user cancelled the request, check if your permissions were given in {@see
